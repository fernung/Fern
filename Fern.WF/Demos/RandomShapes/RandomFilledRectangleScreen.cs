...
{
    public class RandomFilledRectangleScreen : RandomShapeScreen
    {
        protected int x0, y0;
        protected int x1, y1;
        protected Pixel color;

        public RandomFilledRectangleScreen(Client client) :
            base(client)
        {
        }
        ...
        {
            _client.Graphics.FillRectangle(x0, y0, Math.Abs(x1 - x0), Math.Abs(y1 - y0), color);
        }
    }
}
